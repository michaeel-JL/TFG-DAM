...
import com.example.medic.Models.Usuarios;
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) { //Si el usuario y contraseña son correctos, se carga el PacienteActivity.
                                       ...
                                       /* final FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
                                        ...
                                        if(currentUser != null) {
                                            mDataBase.child("rol").getDatabase().get;
                                        }
                                        for (DataSnapshot ds : dataSnapshot.getChildren()) {

                                        }
                                        }
                                        System.out.println("USERRRRRRRRRRRR"+mAuth.getCurrentUser().getEmail());
                                        System.out.println("USERRRRRRRRRRRR"+  mDataBase.child("rol"));*/
